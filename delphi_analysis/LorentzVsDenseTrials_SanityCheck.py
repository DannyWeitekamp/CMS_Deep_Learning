...
observ_types = ['E/c', 'Px', 'Py', 'Pz', 'PT_ET','Eta', 'Phi']
...
def genModel(name,out_dim, depth, width, dense_activation="relu", dropout = 0.0,sphereCoords=True,weight_output=False, output_activation='softmax'):
    inputs = []
    mergelist = []
